...
import { SCALE_DEMO, INDENT } from '../../constants/index'
...
export default class Point {
  ...
  createTexture() {
    ...
    this.pointTexture = {};
    this.pointTexture.x = INDENT + this.props.pos.x * SCALE_DEMO;
    this.pointTexture.y = INDENT + this.props.pos.y * SCALE_DEMO;
  }
  createDisplayObj() {
    this.displayObj = {
      parent: 'none',
