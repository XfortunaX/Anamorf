import { WIDTH_ANAMORF, HEIGHT_ANAMORF, MIN_ANAMORF, WIDTH_ANAMORF_DEMO, HEIGHT_ANAMORF_DEMO } from '../constants/index'

export default class AnamorfModel {

  constructor() {
    if (AnamorfModel.instance) {
      return AnamorfModel.instance;
    }
    this.props = {
      numMatrix: 1,
      active: 0,
